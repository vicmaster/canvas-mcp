...
- **C5 — Usability severity stance.** ✅ *Confirmed (2026-08-08):* the hit-target floor (24px) lands as **error** — beautiful UI that fails WCAG 2.2 AA isn't beautiful UI, same standing as the contrast gate. Label association as **warning**; vague copy as **info**. The fixtures in FR-C1 keep the checks conservative.
